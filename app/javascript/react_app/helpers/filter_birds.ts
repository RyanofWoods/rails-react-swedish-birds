import { BirdFilters, BirdWithOrWithoutObservation, ObservationDict } from '../types/birdData'
...
const filterBirds = ({ birds, observations, filters }: Options): BirdWithOrWithoutObservation[] => {
